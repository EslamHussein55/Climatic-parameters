...
#  #       'min_child_weight': Real(0.0001, 0.5, "log-uniform"),
#  #       'gamma': Real(0.0,20.0),
# #        'learning_rate': Real(0.0005,0.3,"log-uniform")
# #         'subsample': Real(0.01,1.0,"log-uniform"),
# #         'colsample_bylevel': Real(0.1,1.0,"log-uniform"),
# #         'colsample_bytree': Real(0.1,1.0,"log-uniform"),
# }    
...
estimator = XGBRegressor(n_jobs = -1, verbose=1)
#############################################################
