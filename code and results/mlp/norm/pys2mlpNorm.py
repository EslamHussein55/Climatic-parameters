...
# rain  = "C:/Users/Admin/Documents/Work/Data/pre/seasonal/pre_processed/rainF_mad/*.png"
# evap  = "C:/Users/Admin/Documents/Work/Data/pre/seasonal/pre_processed/evap_mad/*.png"
# humid = "C:/Users/Admin/Documents/Work/Data/pre/seasonal/pre_processed/humid_mad/*.png"
# temp  = "C:/Users/Admin/Documents/Work/Data/pre/seasonal/pre_processed/temp_mad/*.png"
# wind  = "C:/Users/Admin/Documents/Work/Data/pre/seasonal/pre_processed/wind_mad/*.png"

# rain  = "C:/Users/Admin/Documents/Work/Data/pre/seasonal/monthlyAve/rainF_madAve/*.png"
# evap  = "C:/Users/Admin/Documents/Work/Data/pre/seasonal/monthlyAve/evap_madAve/*.png"
# humid = "C:/Users/Admin/Documents/Work/Data/pre/seasonal/monthlyAve/humid_madAve/*.png"
# temp  = "C:/Users/Admin/Documents/Work/Data/pre/seasonal/monthlyAve/temp_madAve/*.png"
# wind  = "C:/Users/Admin/Documents/Work/Data/pre/seasonal/monthlyAve/wind_madAve/*.png"
...
#     def __init__( self, layer1=10, layer2=10, layer3=10, activation='relu',alpha=0.0001, batch_size=100, early_stopping=True, learning_rate_init=0.001, max_iter=500, learning_rate='constant', verbose=False, solver='sgd'):
    def __init__( self, layer1=10, activation='relu',alpha=0.0001, batch_size=100, early_stopping=True, learning_rate_init=0.001, max_iter=500, learning_rate='constant', verbose=False, solver='sgd'):
...
seqLengthArr = [12]
monthAhead = [0]
features = [[11], [0] , [0, 11],   [0, 11, 1, 2], [0, 11, 1, 10] ]
...
#         'alpha': (0.00001, 1.5, 'log-uniform'),
#         'learning_rate_init': (0.003, 0.3, 'log-uniform'),
#         'solver' :   ['sgd', 'adam'],
...
#     }
alpha = 3.** np.arange(-8, 0)
learning_rate_init = 3.** np.arange(-5, 0)
param_grid = {
        'layer1': [8, 16, 32, 64, 128],
        'alpha': alpha,
...
estimator = MLPWrapper(max_iter=500)
#############################################################
for dataInd in range (5):    
    for lag in seqLengthArr:
        ...
        ################################################################################
                print()
                print("Heloo every one,this is a grid search on ("+str(feat)+" features, MonthAhead: "+ str(month + 1))
                print()

                start_time = time.time()
               # reg =  BayesSearchCV(estimator, search_spaces = param_grid, cv=scv, scoring = scorer ,n_jobs=-1, verbose = 1)
